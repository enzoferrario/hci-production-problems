...
1. Go to the TypeConnection game at http://www.typeconnection.com/. Play it until you arrive at
   ...
   1. http://www.typeconnection.com/step5/eb.php
   2. http://www.typeconnection.com/step5/kj.php
   3. http://www.typeconnection.com/step5/sh.php
...
4. Next, here in the `pp-01` directory, work with the starter HTML file to set up some content to
   ...
   imaginative. Maybe you have a short paragraph of explanatory text complemented by a pull quote, a piece of information about one or both of your typefaces, or something else.
...
6. Next, get to work with the starter CSS file. It opens with the minified Eric Meyer Reset
   CSS file found at https://gist.github.com/profstolley/b1f851e061f98fcbc0e41d39adc32847#file-reset-min-css. Be sure to begin your own styles *below* the reset styles.
